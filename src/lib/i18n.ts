...
const zh: Record<string, string> = {
  ...
  "assessable": "可評估", "awaiting": "觀察中", "among assessable sends": "以可評估的已寄送為分母", "d window": "天觀察期",
  "assessable sends (outcome recorded, or observation window elapsed)": "可評估的已寄送（已記結果，或觀察期已滿）",
  "Strategy recommendations": "策略建議", "analysis only — adopting is your decision, and it is recorded": "僅供分析 — 是否採用由你決定，決定會被記錄",
  "Adopt": "採用", "adopted": "已採用", "dismissed": "已略過",
  "Adopted — reflect it yourself in the ICP:": "已採用 — 請自行反映到 ICP：", "edit ICP": "編輯 ICP",
